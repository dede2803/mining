    ...
    if($IP != ""){
        ...
        */
        ...
        function login($email,$token,$header){
            $url="https://adapayu.top/auth/login";
        ...
        function test() {
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL,"https://adapayu.top/faucet/currency/ada");
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        ...
        function currency(){
            $url = "https://adapayu.top/faucet/currency/ada";
            return curl($url,'',head())[1];
        }
            
        function claim($aft,$ctn,$tkn,$header){
            $url = "https://adapayu.top/faucet/verify/ada";
        ...
        $login=login($email,$token,array_merge(head(),array("Referer: https://adapayu.top/")));
        sleep(5);
        ...
        while(true)
        {
            for ($adaPayuTop = 0; $adaPayuTop < 50; $adaPayuTop++) {
                ...
                if($sttsBal == "Empty"){
                    echo $check2;
                    echo $WhiteTebal. "Server ". $YellowTebal . "PAYU TOP ". $WhiteTebal. "Coin Crypto ". $YellowTebal . "ADA ". $RedTebal. "Sedang Kosong.".$WhiteTebal. "Tunggu Besok Lagi !!!\n";
                    sleep(2);
                    session_destroy(true);
                    sleep(2);
                    system('rm cookie.txt');
                    sleep(2);
                    system('php bchYUT.php');
                }
                ...
                if($alert == "danger"){
                    echo $WhiteTebal. "[1]. Server ". $YellowTebal . "PAYU TOP ". $WhiteTebal. "Coin Crypto ". $YellowTebal . "ADA ". $RedTebal. "Habis.".$WhiteTebal. "Tunggu Besok Lagi !!!\n";
                    sleep(2);
                    session_destroy(true);
                    sleep(2);
                    system('rm cookie.txt');
                    ...
                    if($aft == ""){
                        ...
                        wktClaim($timeClaim);
                        sleep(2);
                        $claim = claim($aft,$ctn,$tkn,array_merge(head(),array("Referer: https://adapayu.top/faucet/currency/ada")));
                    
                        echo $WhiteTebal ."Selamat, claim ".$GreenTebal."BERHASIL.!!!";
                        sleep(2);
                        echo "\r                                                                \r";
                        sleep(2);
                        echo $WhiteTebal ."SERVER        = ". $YellowTebal. "ADA PAYU TOP\n";
                        sleep(2);
