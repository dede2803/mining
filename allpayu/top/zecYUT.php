...
function curl($url, $post = 0, $httpheader = 0, $proxy = 0){ 
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE,"cookieZecYUT.txt");
    curl_setopt($ch, CURLOPT_COOKIEJAR,"cookieZecYUT.txt");
...
for ($adaPayuTop = 0; $adaPayuTop < 50; $adaPayuTop++) 
{
    ...
    if($IP != ""){
        ...
        */
        ...
        function test() {
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL,"https://zecpayu.top/faucet/currency/zec");
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        ...
        function currency(){
            $url = "https://zecpayu.top/faucet/currency/zec";
            return curl($url,'',head())[1];
        }
            
        function claim($aft,$ctn,$tkn,$header){
            $url = "https://zecpayu.top/faucet/verify/zec";
        ...
        $login=login($email,$token,array_merge(head(),array("Referer: https://zecpayu.top/")));
        sleep(5);
        ...
        while(true)
        {
            for ($adaPayuTop = 0; $adaPayuTop < 50; $adaPayuTop++) {
                ...
                if($sttsBal == "Empty"){
                    echo $check2;
                    echo $WhiteTebal. "Server ". $YellowTebal . "PAYU TOP ". $WhiteTebal. "Coin Crypto ". $YellowTebal . "ZEC ". $RedTebal. "Sedang Kosong.".$WhiteTebal. "Tunggu Besok Lagi !!!\n";
                    sleep(2);
                    session_destroy(true);
                    sleep(2);
                    system('rm cookieZecYUT.txt');
                    sleep(2);
                ...
                if($alert == "danger"){
                    echo $WhiteTebal. "[1]. Server ". $YellowTebal . "PAYU TOP ". $WhiteTebal. "Coin Crypto ". $YellowTebal . "ZEC ". $RedTebal. "Habis.".$WhiteTebal. "Tunggu Besok Lagi !!!\n";
                    sleep(2);
                    session_destroy(true);
                    sleep(2);
                    system('rm cookieZecYUT.txt');
                    ...
                    if($aft == ""){
                        ...
                        wktClaim($timeClaim);
                        sleep(2);
                        $claim = claim($aft,$ctn,$tkn,array_merge(head(),array("Referer: https://zecpayu.top/faucet/currency/zec")));
                    
                        echo $WhiteTebal ."Selamat, claim ".$GreenTebal."BERHASIL.!!!";
                        sleep(2);
                        echo "\r                                                                \r";
                        sleep(2);
                        echo $WhiteTebal ."SERVER        = ". $YellowTebal. "ZEC PAYU TOP\n";
                        sleep(2);
