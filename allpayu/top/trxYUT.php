...
function curl($url, $post = 0, $httpheader = 0, $proxy = 0){ 
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE,"cookieTrxYUT.txt");
    curl_setopt($ch, CURLOPT_COOKIEJAR,"cookieTrxYUT.txt");
...
for ($adaPayuTop = 0; $adaPayuTop < 50; $adaPayuTop++) 
{
    ...
    if($IP != ""){
        ...
        */
        ...
        function test() {
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL,"https://trxpayu.top/faucet/currency/trx");
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        ...
        function currency(){
            $url = "https://trxpayu.top/faucet/currency/trx";
            return curl($url,'',head())[1];
        }
            
        function claim($aft,$ctn,$tkn,$header){
            $url = "https://trxpayu.top/faucet/verify/trx";
        ...
        $login=login($email,$token,array_merge(head(),array("Referer: https://trxpayu.top/")));
        sleep(5);
        ...
        while(true)
        {
            for ($adaPayuTop = 0; $adaPayuTop < 50; $adaPayuTop++) {
                ...
                if($sttsBal == "Empty"){
                    echo $check2;
                    echo $WhiteTebal. "Server ". $YellowTebal . "PAYU TOP ". $WhiteTebal. "Coin Crypto ". $YellowTebal . "TRX ". $RedTebal. "Sedang Kosong.".$WhiteTebal. "Tunggu Besok Lagi !!!\n";
                    sleep(2);
                    session_destroy(true);
                    sleep(2);
                    system('rm cookieTrxYUT.txt');
                    sleep(2);
                    system('php xrpYUT.php');
                }
                ...
                if($alert == "danger"){
                    echo $WhiteTebal. "[1]. Server ". $YellowTebal . "PAYU TOP ". $WhiteTebal. "Coin Crypto ". $YellowTebal . "TRX ". $RedTebal. "Habis.".$WhiteTebal. "Tunggu Besok Lagi !!!\n";
                    sleep(2);
                    session_destroy(true);
                    sleep(2);
                    system('rm cookieTrxYUT.txt');
                    ...
                    if($aft == ""){
                        ...
                        wktClaim($timeClaim);
                        sleep(2);
                        $claim = claim($aft,$ctn,$tkn,array_merge(head(),array("Referer: https://trxpayu.top/faucet/currency/trx")));
                    
                        echo $WhiteTebal ."Selamat, claim ".$GreenTebal."BERHASIL.!!!";
                        sleep(2);
                        echo "\r                                                                \r";
                        sleep(2);
                        echo $WhiteTebal ."SERVER        = ". $YellowTebal. "TRX PAYU TOP\n";
                        sleep(2);
