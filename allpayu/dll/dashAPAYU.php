...
function curl($url, $post = 0, $httpheader = 0, $proxy = 0)
{
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "cookieDashAPAYU.txt");
    curl_setopt($ch, CURLOPT_COOKIEJAR, "cookieDashAPAYU.txt");
...
for ($adaPayuTop = 0; $adaPayuTop < 50; $adaPayuTop++) {
    ...
    if ($IP != "") {
        ...
        */
        ...
        function get()
        {
            $url = "https://autopayu.top/";
            return curl($url, '', head())[1];
        }

        function login($email, $token, $header)
        {
            $url = "https://autopayu.top/auth/login";
        ...
        {
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, "https://autopayu.top/faucet/currency/dash");
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        ...
        function currency()
        {
            $url = "https://autopayu.top/faucet/currency/dash";
            return curl($url, '', head())[1];
        }

        function claim($aft, $ctn, $tkn, $header)
        {
            $url = "https://autopayu.top/faucet/verify/dash";
        ...
        while (true) {
            for ($adaPayuTop = 0; $adaPayuTop < 50; $adaPayuTop++) {
                ...
                if ($sttsBal == "Empty") {
                    echo $check2;
                    echo $WhiteTebal . "Server " . $YellowTebal . "AUTO PAYU " . $WhiteTebal . "Coin Crypto " . $YellowTebal . "DASH " . $RedTebal . "Sedang Kosong." . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                    sleep(2);
                    session_destroy(true);
                    sleep(2);
                    system('rm cookieDashAPAYU.txt');
                    sleep(2);
                ...
                if ($alert == "danger") {
                    echo $WhiteTebal . "[1]. Server " . $YellowTebal . "AUTO PAYU " . $WhiteTebal . "Coin Crypto " . $YellowTebal . "DASH " . $RedTebal . "Habis." . $WhiteTebal . "Tunggu Besok Lagi !!!\n";
                    sleep(2);
                    session_destroy(true);
                    sleep(2);
                    system('rm cookieDashAPAYU.txt');
                    ...
                    if ($aft == "") {
                        ...
                        wktClaim($timeClaim);
                        sleep(2);
                        $claim = claim($aft, $ctn, $tkn, array_merge(head(), array("Referer: https://autopayu.top/faucet/currency/dash")));

                        echo $WhiteTebal . "Selamat, claim " . $GreenTebal . "BERHASIL.!!!";
                        sleep(2);
                        echo "\r                                                                \r";
                        sleep(2);
                        echo $WhiteTebal . "SERVER        = " . $YellowTebal . "DASH AUTO PAYU TOP\n";
                        sleep(2);
